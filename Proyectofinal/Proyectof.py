...
ventana=Tk()
ventana.title("CALCULADORA de MARINO B)")
...
Button(ventana,text="*",bg=color_boton,width=ancho_boton,height=alto_boton,command=lambda:btnClik("x")).place(x=197,y=360)
